...
import { getAllServiceHistory } from "../../services/admin-service";
...
export default function ServiceHistoryDashboard() {
  ...
  useEffect(() => {
    ...
    getAllServiceHistory()
      ...
      .catch(err => {
        console.error(err);
        setError("Failed to load service history. Please check your connection.");
        setLoading(false);
      });
  }, []);
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12, marginBottom: 22 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                ...
                <p style={{ margin: "3px 0 0", fontSize: 12, opacity: 0.65 }}>Admin Dashboard · All Records</p>
              </div>
            </div>
            <button
              onClick={() => { setLoading(true); getAllServiceHistory().then(r => { setData(r); setLoading(false); }).catch(() => setLoading(false)); }}
                      ...
                      >
                        ...
                        <td style={{ padding: "11px 14px" }}>
                          <button
                            ...
                            style={{ background: "#eef2ff", color: "#6366f1", border: "none", padding: "5px 12px", borderRadius: 8, cursor: "pointer", fontSize: 12, fontWeight: 700 }}
                          >
                            View
                          </button>
                        </td>
